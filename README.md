...
* **Method A:** Reference process
* **Method B:** Faster and lower-cost alternative process

The objective is to determine which method gives better yield, evaluate wafer-to-wafer stability, identify spatial failure patterns, and provide an engineering recommendation for further production development.
...
* Compare overall yield between Method A and Method B
...
* Rank the best and worst wafers based on yield
...
![Comparison Between Method A and B](./Figures/comparison_betwee_metthod_aandb.png)
...
![Overall Wafer Ranking](./Figures/overall_wafer_ranking_best_to_worst.png)
